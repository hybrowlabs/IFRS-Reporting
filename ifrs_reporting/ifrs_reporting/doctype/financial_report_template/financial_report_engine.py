...
from ifrs_reporting.ifrs_reporting.doctype.financial_report_row.financial_report_row import FinancialReportRow
from ifrs_reporting.ifrs_reporting.doctype.financial_report_template.financial_report_template import (
	FinancialReportTemplate,
)
from ifrs_reporting.ifrs_reporting.doctype.financial_report_template.financial_report_validation import (
...
def get_children_accounts(
	...
	try:
		...
		children_accounts = get_children(doctype, parent, company, is_root=is_root)
